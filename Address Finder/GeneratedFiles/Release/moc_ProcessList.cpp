...
static const char qt_meta_stringdata_ProcessList[] = {
    "ProcessList\0\0QPushButton_Clicked()\0"
    "QTreeWidget_ItemDoubleClicked()\0"
};
...
void ProcessList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        ProcessList *_t = static_cast<ProcessList *>(_o);
        switch (_id) {
        case 0: _t->QPushButton_Clicked(); break;
        case 1: _t->QTreeWidget_ItemDoubleClicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData ProcessList::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ProcessList::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ProcessList,
      qt_meta_data_ProcessList, &staticMetaObjectExtraData }
};
